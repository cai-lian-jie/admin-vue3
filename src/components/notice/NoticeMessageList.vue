<template>
  <el-tabs v-model="activeName" :class="wrapClass" @tab-click="handleTabClick" :style="wrapStyle">
      ...
      <ul v-if="tab.contents && tab.contents.length">
        ...
        >
          <el-row justify="center" align="middle">
            ...
            >
              <!-- 头像 -->
              <el-avatar v-bind="Object.assign({ size: 'small' }, item.avatar)"></el-avatar>
            </el-col>
  ...
  <!-- buttons -->
  <div class="flex justify-around border-t w-full justify-around">
    <div
      class="flex-1 flex items-center justify-center py-3 border-r hover:bg-sky-100 cursor-pointer text-gray-500"
...
import type { AvatarProps, TabsPaneContext, Event } from 'element-plus'
import { NoticeMessageListProps, MessageListItem } from './types'
